...
Now that you understand security, check out some [Useful Examples](/lune-custom-build-doc/getting-started/5-useful-examples/) to start building real scripts.
